<div id="printableArea" class="max-w-4xl mx-auto bg-white p-8 mt-12 shadow-lg rounded-lg">
    ...
    <div class="mt-12">
        ...
        <p class="mt-4 text-justify">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            This is to certify that <span class="underline">__<?= htmlspecialchars($fullName) ?>____</span>, 
            <span class="underline">__<?= htmlspecialchars((string)$age) ?>__</span> years old, is a bona fide resident of 
            Barangay 434, Zone 44, Fourth District, Manila.
        </p>
        <p class="mt-4 text-justify">
            This certification is issued to <span class="underline"><?= htmlspecialchars($fullName) ?></span> upon his/her request for 
    ...
    <div class="mt-8">
        <p class="text-justify">
            ...
            <span class="underline">_______<?= htmlspecialchars($month) ?>_______</span>, 
            <?= htmlspecialchars((string)$year) ?> at Barangay 434, Zone 44, Fourth District, Manila.
        </p>
    </div>
